...
class MixinASRDatasetTest:
    ...
    def test_asr__len__(self, asr_dataset: ASRDataset, samples: list[ASRSample]):
        MixinDatasetTest.test__len__(self, asr_dataset, samples)

    def test_asr__iter__(self, asr_dataset: ASRDataset, samples: list[ASRSample]):
        MixinDatasetTest.test__iter__(self, asr_dataset, samples)

    def test_asr__getitem__(self, asr_dataset: ASRDataset, samples: list[ASRSample]):
        MixinDatasetTest.test__getitem__(self, asr_dataset, samples)
    ...
    def test_asr_sample(self, asr_dataset: ASRDataset, samples: list[ASRSample]):
        MixinDatasetTest.test_sample(self, asr_dataset, samples)
    ...
    def test_asr__add__(self, asr_dataset: ASRDataset):
        MixinDatasetTest.test__add__(self, asr_dataset)

    def test_asr_to_dict_and_from_dict(
        self, asr_dataset: ASRDataset, samples: list[ASRSample]
    ):
        MixinDatasetTest.test_to_dict_and_from_dict(self, asr_dataset, samples)

    def test_asr_to_pointer_and_from_pointer(
        self, asr_dataset: ASRDataset, samples: list[ASRSample]
    ):
        MixinDatasetTest.test_to_pointer_and_from_pointer(self, asr_dataset, samples)
